...
@Entity
@Table(name = "nac")
public class Nac implements java.io.Serializable, AssociableEntity {
    ...
    @OneToMany(fetch = FetchType.LAZY, mappedBy = "nac")
    private Set<Lokality> lokalities = new HashSet<Lokality>(0);
    ...
    public Nac(int id, String meno, boolean schvalene, Set<Lokality> lokalities) {
        this.id = id;
        this.meno = meno;
