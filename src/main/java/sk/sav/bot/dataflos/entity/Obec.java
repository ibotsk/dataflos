...
@Entity
@Table(name = "obec")
public class Obec implements java.io.Serializable, AssociableEntity {
    ...
    @OneToMany(fetch = FetchType.LAZY, mappedBy = "obec")
    ...
    public Obec(int id, String meno, boolean schvalene, Set<Lokality> lokalities) {
        this.id = id;
        this.meno = meno;
