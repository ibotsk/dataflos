 ...
 */
@Entity
@Table(name = "family_apg")
public class FamilyApg implements java.io.Serializable, AssociableEntity {
    ...
    @OneToMany(fetch = FetchType.LAZY, mappedBy = "familyApg")
    ...
    public FamilyApg(String meno, boolean schvalene, Set<Genus> genera) {
        this.meno = meno;
        this.schvalene = schvalene;
        this.genera = genera;
    }
