 ...
 */
@Entity
public class TaxonPovodnost implements java.io.Serializable, AssociableEntity {
	...
	@OneToMany(fetch = FetchType.LAZY, mappedBy = "taxonPovodnost")
    private Set<ListOfSpecies> listOfSpecies = new HashSet<>(0);

    public TaxonPovodnost() {
    }

    public TaxonPovodnost(String skratka, String popis, Set<ListOfSpecies> listOfSpecies) {
