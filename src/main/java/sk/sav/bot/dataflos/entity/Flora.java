...
@Entity
@Table(name = "flora")
public class Flora implements java.io.Serializable, AssociableEntity {
    ...
    @OneToMany(fetch = FetchType.LAZY, mappedBy = "flora")
    private Set<Lokality> lokalities = new HashSet<>(0);

    public Flora() {
    }

    public Flora(String meno, boolean schvalene, Set<Lokality> lokalities) {
        this.meno = meno;
