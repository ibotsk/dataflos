...
@Entity
@Table(name = "ngc")
public class Ngc implements java.io.Serializable, AssociableEntity {
    ...
    @OneToMany(fetch = FetchType.LAZY, mappedBy = "ngc")
    ...
    public Ngc(int id, String meno, boolean schvalene, Set<Lokality> lokalities) {
        this.id = id;
        this.meno = meno;
