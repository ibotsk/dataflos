...
@Entity
@Table(name = "casopisy")
public class Casopisy implements java.io.Serializable, AssociableEntity {
    ...
    @OneToMany(fetch = FetchType.LAZY, mappedBy = "casopis")
    private Set<LitZdroj> litZdrojs = new HashSet<>(0);

    public Casopisy() {
    }

    public Casopisy(String meno, String skratka, boolean schvalene, Set<LitZdroj> litZdrojs) {
        this.meno = meno;
    ...
    public Set<LitZdroj> getLitZdrojs() {
        return this.litZdrojs;
    }

    public void setLitZdrojs(Set<LitZdroj> litZdrojs) {
        this.litZdrojs = litZdrojs;
    }
